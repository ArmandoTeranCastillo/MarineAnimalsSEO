<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('image_url', $product->image_url, ['class' => 'form-control' . ($errors->has('image_url') ? ' is-invalid' : ''), 'placeholder' => 'Image Url']) }}
        ...
        <div class="form-group">
            {{ Form::label('featured') }}
            {{ Form::text('featured', $product->featured, ['class' => 'form-control' . ($errors->has('featured') ? ' is-invalid' : ''), 'placeholder' => 'Featured']) }}
